...
{
    screen = QApplication::screens().at(currentScreenIndex)->geometry().size();
    isResized = false;
    isExit = false;
    resizeOffIcon = new QPixmap(":/Resources/Icon/ic_resize_fw_off.png");
    resizeOnIcon = new QPixmap(":/Resources/Icon/ic_resize_fw_on.png");
    exitOffIcon = new QPixmap(":/Resources/Icon/ic_exit_off.png");
    exitOnIcon = new QPixmap(":/Resources/Icon/ic_exit_on.png");
    ...
    setTitle("");
    setWindowFlags(/*Qt::X11BypassWindowManagerHint |*/ Qt::WindowStaysOnTopHint | Qt::FramelessWindowHint /*| Qt::Popup*/);
