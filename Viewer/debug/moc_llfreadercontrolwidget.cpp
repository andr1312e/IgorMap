...
void LLFRSlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<LLFRSlider *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject LLFRSlider::staticMetaObject = { {
    ...
    qt_meta_stringdata_LLFRSlider.data,
    qt_meta_data_LLFRSlider,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
QT_INIT_METAOBJECT const QMetaObject LLFReaderCWButton::staticMetaObject = { {
    ...
    qt_meta_stringdata_LLFReaderCWButton.data,
    qt_meta_data_LLFReaderCWButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<LLFReaderControlWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject LLFReaderControlWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_LLFReaderControlWidget.data,
    qt_meta_data_LLFReaderControlWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
