...
void UIController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (UIController::*)(QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UIController::sendMsg)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void UIController::sendMsg(QByteArray _t1)
{
